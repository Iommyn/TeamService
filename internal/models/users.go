...
func (r *userR) GetTeamsUsers() TeamsUserSlice {
	if r == nil {
		return nil
	}
	return r.TeamsUsers
...
func (r *userR) GetTournamentsUsers() TournamentsUserSlice {
	if r == nil {
		return nil
	}
...
func (o *User) TeamsUsers(mods ...qm.QueryMod) teamsUserQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"teams_users\".\"user_id\"=?", o.ID),
	)
...
func (o *User) TournamentsUsers(mods ...qm.QueryMod) tournamentsUserQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"tournaments_users\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadTeamsUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`teams_users`),
		qm.WhereIn(`teams_users.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadTournamentsUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`tournaments_users.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddTeamsUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TeamsUser) error {
	var err error
...
// Sets related.R.User appropriately.
func (o *User) AddTournamentsUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*TournamentsUser) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
