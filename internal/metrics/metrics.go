...
const namespace = "team_service"

var TeamHTTPRequest = promauto.NewCounterVec(
...
var Team5xxRequest = promauto.NewCounterVec(
	prometheus.CounterOpts{
		Namespace: namespace,
...
var TeamRequestDuration = promauto.NewHistogramVec(
...
var TeamCPUUsage = promauto.NewGauge(
...
var TeamMemoryUsage = promauto.NewGauge(
	prometheus.GaugeOpts{
		Namespace: namespace,
		Name:      "memory_usage",
...
var TeamTrafficInbound = promauto.NewHistogram(
	prometheus.HistogramOpts{
		Namespace: namespace,
...
var TeamTrafficOutbound = promauto.NewHistogram(
	prometheus.HistogramOpts{
		Namespace: namespace,
